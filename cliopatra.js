...
/////////////////////////////////////////////////////////////////////////////*/
  ...
  Clio.prototype.usage  = function( err, exit ){
    console.log('You arent doing it right!', err);
    if( exit ){ process.exit(1); }
  };

  Clio.prototype.clioFile = function( filename ){
  ...
  Clio.prototype._clioFile = function(){};

  Clio.prototype.option = function(){
  ...
  Clio.prototype._parseOption = function( flag, desc, fn ){
  ...
  Clio.prototype._parseArg = function( args ){
    let $$ = this._input;
